...
import com.example.demo3.model.ModelPengingat;
...
public class PengingatAdapter extends BaseAdapter {
    ...
    private ArrayList<ModelPengingat> arrayList;

    public PengingatAdapter(Context context, ArrayList<ModelPengingat> arrayList) {
        super();
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        convertView = layoutInflater.inflate(R.layout.item_grid_pengingat, null);
        ...
        ModelPengingat modelData = arrayList.get(position);
