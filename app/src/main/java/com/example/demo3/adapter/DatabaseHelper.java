...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<ModelPengingat> getAllData() {
        ArrayList<ModelPengingat> arrayList = new ArrayList<>();
        ...
        while (cursor.moveToNext()) {
            ...
            ModelPengingat modelData = new ModelPengingat(id, title, date, time);
