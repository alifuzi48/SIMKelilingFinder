...
public class InfoSimA extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_infosima);
        tbSIMA = findViewById(R.id.toolbar_simA);
        tbSIMA.setTitle("Perpanjang SIM A");
        setSupportActionBar(tbSIMA);
        assert getSupportActionBar() != null;
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        pindahJam = findViewById(R.id.btnAMoveJam);
        pindahBiaya = findViewById(R.id.btnAMoveBiaya);
